...
def write_poem(parts,name,i):
    fp = "D:/Data/Poems/{}/poem_{}.txt".format(name,i)
...
if __name__ == "__main__":
    CM = ContentMatcher()
    author_a = consolidate_content("./src/4. Lazyness/A.txt",CM)
    author_b = consolidate_content("./src/4. Lazyness/B.txt",CM)
    generate_poems(author_a, author_b, 10000)